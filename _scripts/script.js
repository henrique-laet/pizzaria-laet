...
$('div#testemunha-direita').click(function () {
    ...
    if (limite > (nova_posicao - view_largura)) {
        ...
        $('div#testemunha-direita ion-icon').css('cursor', 'not-alloowed');
    }
...
$('div#transicao-testemunha-plano').waypoint(function (direcao) {
    if (direcao == 'down') {
        ...
        $('div#decoracao1').removeClass('animate__animated animate__fadeOutLeft animate__slower');
        $('div#decoracao2').removeClass('animate__animated animate__fadeOut animate__slower');
        $('div#decoracao3').removeClass('animate__animated animate__fadeOutRight animate__slower');

        $('div#decoracao1').addClass('animate__animated animate__fadeInLeft animate__slower');
        $('div#decoracao2').addClass('animate__animated animate__fadeIn animate__slower');
        $('div#decoracao3').addClass('animate__animated animate__fadeInRight  animate__slower');
    } else {
        $('div#decoracao1').addClass('animate__animated animate__fadeOutLeft animate__slower');
        $('div#decoracao2').addClass('animate__animated animate__fadeOut animate__slower');
        $('div#decoracao3').addClass('animate__animated animate__fadeOutRight animate__slower');
    }
}, {
    offset: '600px;'
})
